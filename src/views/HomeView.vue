...
export default {
  ...
  data: () => ({
    ...
    text2:
      "Etiam feugiat eleifend est, odio tempor viate. Vivamus maximus scelerisque ipsum nec commodo.",
    text3:
      "Quickly predominate standard compliant architecture and may have prospective internal or organic sources.",
  }),
};
</script>
